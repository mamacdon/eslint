...
module.exports = (function() {
	...
	/**
	 * Sets the rules. Use this method if you want to load a dynamic set of rules at runtime rather than relying on the 'rules'
	 * subdirectory. Helpful for AMD environments.
	 * @param {Object} An object specifying the rules to use. Its keys are rule IDs and its values are rule objects (see the 
	 * 'rules' subdirectory for examples).
	 */
	api.setRules = function(r) {
		rules = r;
	};
